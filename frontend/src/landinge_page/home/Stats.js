    ...
    <div className='container p-3'>
      <div className='row p-5'>
        <div className='col-6 p-5'>
          ...
          <p className='text-muted'>Not just an app, but a whole ecosystem. Our invesment in 30+ fintech startups offer you tailored services spacific to your needs</p>
          <h2 className='fs-4'>Do better with money</h2>
          <p className='text-muted'>With iniatives like Nudge and kill swithch, we don't just faciliate transaction, but actively help you  do better with your money.</p>
        </div>
        <div className='col-6 p-5'>
