          ...
          <div className='row p-5 mt-5 mb-5'>
            <h1 className='fs-2'>To create a ticket, select a relevant topic.</h1>
              ...
              <div className='col-4 p-5 mt-2 mb-2'>
               ...
               <br />
               <a href="" style={{ textDecoration: "none", lineHeight: "2.5"}}>DP ID and bank detail</a>
               <br />
              ...
              <div className='col-4 p-5 mt-2 mb-2'>
               <h4 className=''><i class="fa fa-tasks" aria-hidden="true"></i>Your Zerodha Account</h4>
               ...
               <br />
               <a href="" style={{ textDecoration: "none", lineHeight: "2.5"}}>Pi nad other platform</a>
               <br />
               <a href="" style={{ textDecoration: "none", lineHeight: "2.5"}}>Stockreports+</a>
               <br />
              </div>
              <div className='col-4 p-5 mt-2 mb-2'>
               <h4 className=''><i class="fa fa-list-alt" aria-hidden="true"></i>Funds</h4>
              ...
              <div className='col-4 p-5 mt-2 mb-2'>
               ...
               <br />
               <a href="" style={{ textDecoration: "none", lineHeight: "2.5"}}>Referal Program</a>
               <br />
              </div>
              <div className='col-4 p-5 mt-2 mb-2'>
               ...
               <br />
               <a href="" style={{ textDecoration: "none", lineHeight: "2.5"}}>Goverment Security</a>
               <br />
              </div>
          </div>
        </div>
